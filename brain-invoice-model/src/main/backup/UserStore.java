...
import com.brainmaster.apps.invoicing.model.id.UserStoreKeys;
...
public class UserStore implements Serializable {
	...
	@EmbeddedId
	private UserStoreKeys id;

	public UserStore() {
	}

	public UserStore(UserStoreKeys id) {
		this.id = id;
	}

	public UserStoreKeys getId() {
		return id;
	}

	public void setId(UserStoreKeys id) {
		this.id = id;
	}
