...
public class CompanyInformation implements Serializable {
  ...
  public CompanyInformation(String address1, String address2, String address3, String postalCode,
      String city, String province, String emailAddress, String phoneNumber, String faxNumber,
      String mobileNumber) {
  ...
  public String toString() {
    return "CompanyInformation [address1=" + address1 + ", address2=" + address2 + ", address3="
        + address3 + ", postalCode=" + postalCode + ", city=" + city + ", province=" + province
        + ", emailAddress=" + emailAddress + ", phoneNumber=" + phoneNumber + ", faxNumber="
        + faxNumber + ", mobileNumber=" + mobileNumber + "]";
  }
